...
class View
{
    protected $_head, $_header, $_body, $_footer, $_siteTitle = SITE_TITLE, $_outputBuffer, $_layout = DEFAULT_LAYOUT, $_metaDescription = SITE_DESCRIPTION, $_canonicalUrl = null, $_metaTags = [];
    ...
    {
        $this->_metaDescription = trim($description);
    }
