...
class Model {
  ...
  public static function find($params = []) {
    $instance = new static();
    $params = $instance->_softDeleteParams($params);
    $resultsQuery = $instance->_db->find($instance->_table, $params, get_class($instance));
  ...
  public static function findFirst($params = []) {
    $instance = new static();
    $params = $instance->_softDeleteParams($params);
    $resultQuery = $instance->_db->findFirst($instance->_table, $params, get_class($instance));
    return $resultQuery;
  }
   ...
   */
    ...
    {
        $instance = new static();
        return $instance->findFirst(['conditions' => "id = ?", 'bind' => [$id]]);
    }
  ...
  /**
   * Generate Timestamps for update and insert
   */
