...
class Login extends Model
{
    ...
    {
        $this->runValidation(new RequiredValidator($this, ['field' => 'username', 'msg' => 'Введите имя пользователя']));
        $this->runValidation(new RequiredValidator($this, ['field' => 'password', 'msg' => 'Введите пароль']));
    }
